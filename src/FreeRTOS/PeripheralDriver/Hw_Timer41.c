...
static void OcoIrqCallback(void)
{
    ...
    TIMER4_OCO_ClearIrqFlag(TIMER41_UNIT, TIMER41_OCO_LOW_UCH);
...
//    en_timer4_pwm_ch_t enPwmCh;
    ...
    PWC_Fcg2PeriphClockCmd(PWC_FCG2_PERIPH_EMB, Enable);
        /* Initialize PWM I/O */
    PORT_SetFunc(TIMER41_PWM_UH_PORT, TIMER41_PWM_UH_PIN, Func_Tim4, Disable);
    PORT_SetFunc(TIMER41_PWM_UL_PORT, TIMER41_PWM_UL_PIN, Func_Tim4, Disable);
    PORT_SetFunc(TIMER41_PWM_VH_PORT, TIMER41_PWM_VH_PIN, Func_Tim4, Disable);
    PORT_SetFunc(TIMER41_PWM_VL_PORT, TIMER41_PWM_VL_PIN, Func_Tim4, Disable);
    PORT_SetFunc(TIMER41_PWM_WH_PORT, TIMER41_PWM_WH_PIN, Func_Tim4, Disable);
    PORT_SetFunc(TIMER41_PWM_WL_PORT, TIMER41_PWM_WL_PIN, Func_Tim4, Disable);
    ...
    stcCntInit.u16Cycle = TIMER41_CNT_CYCLE_VAL;
    
    TIMER4_CNT_Init(TIMER41_UNIT, &stcCntInit);
    ...
    TIMER4_OCO_Init(TIMER41_UNIT,TIMER41_OCO_LOW_UCH,&stcOcoInit);
    TIMER4_OCO_Init(TIMER41_UNIT,TIMER41_OCO_LOW_VCH,&stcOcoInit);
    TIMER4_OCO_Init(TIMER41_UNIT,TIMER41_OCO_LOW_WCH,&stcOcoInit);
     if ((Timer4OcoOul == TIMER41_OCO_LOW_UCH) || (Timer4OcoOvl == TIMER41_OCO_LOW_VCH) || (Timer4OcoOwl == TIMER41_OCO_LOW_WCH))
    {
        ...
        TIMER4_OCO_SetLowChCompareMode(TIMER41_UNIT, TIMER41_OCO_LOW_UCH, &stcLowChCmpMode);  /* Set OCO low channel compare mode */
        TIMER4_OCO_SetLowChCompareMode(TIMER41_UNIT, TIMER41_OCO_LOW_VCH, &stcLowChCmpMode);  /* Set OCO low channel compare mode */
        TIMER4_OCO_SetLowChCompareMode(TIMER41_UNIT, TIMER41_OCO_LOW_WCH, &stcLowChCmpMode);  /* Set OCO low channel compare mode */
    }
    else
    {
        /* nop */
    ...
    TIMER4_OCO_WriteOccr(TIMER41_UNIT, TIMER41_OCO_LOW_UCH, 100); /* Set OCO low channel compare value */
    TIMER4_OCO_WriteOccr(TIMER41_UNIT, TIMER41_OCO_LOW_VCH, 200); /* Set OCO low channel compare value */
    TIMER4_OCO_WriteOccr(TIMER41_UNIT, TIMER41_OCO_LOW_WCH, 100); /* Set OCO low channel compare value */

    /* Enable OCO */
    TIMER4_OCO_OutputCompareCmd(TIMER41_UNIT, TIMER41_OCO_LOW_UCH, Enable);
    TIMER4_OCO_OutputCompareCmd(TIMER41_UNIT, TIMER41_OCO_LOW_VCH, Enable);
    TIMER4_OCO_OutputCompareCmd(TIMER41_UNIT, TIMER41_OCO_LOW_WCH, Enable);


    stcEmbInit.enPwmHold = EmbChangePwm;
    stcEmbInit.enEmbState = EmbTrigPwmOutputLowLevel;
    TIMER4_EMB_Init(TIMER41_UNIT, &stcEmbInit);
    ...
    TIMER4_PWM_SetFilterCountValue(TIMER41_UNIT, TIMER41_PWM_UCH, (1000)/2);
    TIMER4_PWM_WriteDeadRegionValue(TIMER41_UNIT, TIMER41_PWM_UCH, 1u, 1u);
    TIMER4_PWM_Init(TIMER41_UNIT, TIMER41_PWM_UCH, &stcPwmInit); /* Initialize timer4 pwm */
    
    TIMER4_PWM_SetFilterCountValue(TIMER41_UNIT, TIMER41_PWM_VCH, (1000)/2);
    TIMER4_PWM_WriteDeadRegionValue(TIMER41_UNIT, TIMER41_PWM_VCH, 1u, 1u);
    TIMER4_PWM_Init(TIMER41_UNIT, TIMER41_PWM_VCH, &stcPwmInit); /* Initialize timer4 pwm */
    
    TIMER4_PWM_SetFilterCountValue(TIMER41_UNIT, TIMER41_PWM_WCH, (1000)/2);
    TIMER4_PWM_WriteDeadRegionValue(TIMER41_UNIT, TIMER41_PWM_WCH, 1u, 1u);
    TIMER4_PWM_Init(TIMER41_UNIT, TIMER41_PWM_WCH, &stcPwmInit); /* Initialize timer4 pwm */
    /* Clear && Start CNT */
    TIMER4_CNT_ClearCountVal(TIMER41_UNIT);
    TIMER4_CNT_Start(TIMER41_UNIT);
}

void Timer41_EMB_Break(void)
{
    EMB_SwBrake(TIMER41_EMB_UNIT,true);
}

void Timer41_EMB_UnBreak(void)
{
    EMB_SwBrake(TIMER41_EMB_UNIT,false);
}
