...
#define I2C1_SCL_PORT   PortA
#define I2C1_SCL_Pin    Pin15
#define I2C1_SDA_PORT   PortB
#define I2C1_SDA_Pin    Pin02
...
//    PORT_Init(I2C1_SCL_PORT,I2C1_SCL_Pin, &Port_CFG);
//    PORT_Init(I2C1_SDA_PORT,I2C1_SDA_Pin, &Port_CFG);
...
{
    uint8_t u8TxBuf[PAGE_LEN],u8RxBuf[PAGE_LEN];
    u8TxBuf[0] = 0xFD;
    Hw_I2C1_Master_Write(E2_ADDRESS,0x03,u8TxBuf,1);
    Ddl_Delay1ms(100); 
    Hw_I2C1_Master_Read(E2_ADDRESS,0x03,u8RxBuf,1);
    Ddl_Delay1ms(100); 
}
void TestEEPROM(void)
{
...
#if 1    
    u8Ret = Hw_I2C1_Master_Write(E2_ADDRESS,DATA_TEST_ADDR,u8TxBuf,PAGE_LEN);
    if(u8Ret != I2C_RET_OK)
    {
    ...
    Ddl_Delay1ms(100);    
#if 1    
    u8Ret = Hw_I2C1_Master_Read(E2_ADDRESS,DATA_TEST_ADDR,u8RxBuf,PAGE_LEN);
    if(u8Ret != I2C_RET_OK)
    {
        M4_I2C1->CR1_f.SWRST = 1;
        Ddl_Delay1ms(1);
