 ...
 */
/******************************************************************************/
/** \file hc32_platform.h
 **
 **   - 2019-02-15  1.0 Hongjh First version
 **
 ******************************************************************************/

#ifndef __HC32_PLATFORM_H__
#define __HC32_PLATFORM_H__
 ...
 ******************************************************************************/
typedef struct hc32_platform_driver
{
    char *name;
    int (*probe)(void *);
    int (*remove)(void *);
} hc32_platform_driver_t;
